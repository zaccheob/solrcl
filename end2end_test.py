...
<schema version="1.5">
  ...
  <fields>
    ...
    <field name="testint" type="int" indexed="true" stored="true" multiValued="false" required="true" />
...
class TestSolrlibWithDocsBlockjoin(TestSolrlibBase):
    def setUp(self):
        ...
        #Load some documents
        docs = (
            '<doc><field name="id">A</field><field name="testdate">2014-01-31T17:20:00Z</field><field name="testint">1</field><field name="testmulti">A1</field><field name="testmulti">A2</field><field name="_is_parent">true</field><doc><field name="id">A.1</field><field name="testint">1</field><field name="testmulti">blabla</field><field name="_is_parent">false</field></doc></doc>',
            '<doc><field name="id">B</field><field name="testdate">2014-01-31T17:20:00Z</field><field name="testint">1</field><field name="testmulti">B1</field><field name="testmulti">B2</field><field name="_is_parent">true</field><doc><field name="id">B.1</field><field name="testint">1</field><field name="testmulti">blabla</field><field name="_is_parent">false</field></doc></doc>',
...
class TestSolrlibLoadDocs(TestSolrlibBase):
    def setUp(self):
        ...
        childdoc.setField("testint", 2)
        doc.addChild(childdoc)
        self.DOC_BLOCKJOIN = doc
        
        # Missing required field testdate
        doc = solrcl.SOLRDocument(u"A", self.solr)
        doc.setField("_is_parent", True)
        self.DOC_ERROR = doc
    ...
    def test_loadDocs_SOLRError(self):
        self.assertRaises(solrcl.ThreadError, self.solr.loadDocs, (self.DOC_ERROR,))
